...
export default function QuotesPage() {
  ...
  return (
    <>
      <div className="p-4 md:p-8 h-dvh flex flex-col bg-[#f4f7f9] animate-in fade-in duration-300 font-sans pb-24 md:pb-8 w-full overflow-hidden">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 scrollbar-hide snap-x">
              {leadsAguardando.map((lead) => (
                <div 
                  ...
                  className="snap-start min-w-45 w-45 sm:max-w-55 bg-emerald-50 border border-emerald-200 rounded-lg p-3 cursor-pointer hover:bg-emerald-100/60 hover:border-emerald-400 hover:shadow-md transition-all group flex flex-col gap-1.5 shrink-0"
                >
                  <div className="flex items-start justify-between">
                    <h4 className="font-bold text-emerald-950 text-xs truncate pr-2 group-hover:text-emerald-700 transition-colors" title={lead.nome}>
                      {lead.nome}
                    </h4>
                  </div>
                  {lead.cnpj && (
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto shrink-0">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <button 
                  ...
                  className="flex-1 sm:flex-none bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-4 py-2.5 rounded-lg text-sm font-bold shadow-sm transition-colors flex items-center justify-center min-w-25"
                >
