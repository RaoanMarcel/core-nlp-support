    ...
    <div className="flex w-full h-full">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-[#f8f9f9]">
        ...
        <header className="bg-white border-b border-slate-200 px-8 py-5 flex justify-between items-center shrink-0">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Core NPL</h1>
          </div>
        ...
        <div className="p-8 flex flex-col gap-5 h-full overflow-y-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 flex-1 min-h-[380px]">
            ...
            {/* COLUNA ESQUERDA (Visão Geral - 3/5) */}
            <div className="lg:col-span-3 flex flex-col gap-5 justify-start">
              ...
              {/* Espaço vazio intencional reservado para o futuro */}
              <div className="flex-1"></div>

            </div>

            {/* COLUNA DIREITA (Ação Imediata - 2/5) */}
            <div className="lg:col-span-2 flex flex-col h-full">
              <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm flex flex-col h-full">
                      ...
                      <div className="flex justify-between items-center mt-1 pt-2.5 border-t border-slate-100">
                        <div className="flex items-center gap-1.5">
                          {ticket.responsavel === 'Não atribuído' ? (
                            <span className="text-[10px] font-bold text-slate-500 bg-slate-200/50 px-1.5 py-0.5 rounded">Livre</span>
                          ) : (
                            <>
                              <div className="w-4 h-4 rounded-full bg-slate-800 flex items-center justify-center text-[8px] font-bold text-white shadow-sm">
                ...
                <button className="w-full mt-4 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold py-2.5 rounded-xl transition-colors shadow-sm">
